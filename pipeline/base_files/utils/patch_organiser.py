...
def organise_patches_into_directories(source_dir):
    """
    Organize image patches into directories based on their patch number.

    Args:
    - source_dir: Directory containing the patches to organize.
    """
