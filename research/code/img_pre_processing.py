'''
First utility function to create metadata and patches to feed the different networks
This approach works pretty good and allows me to sub-divide the image in the LEGO patches
as describen in my project. Nothing Fancy but very effective
'''
