'''
This is another attempt at vanilla programming a CNN to try testing
my knowledge on the subject. While the training works, the results are not really as expected
I Will continue to modify this path to trying understand what the best coruse of action is. 
I will stage these but not commit them. These structure and architecture has been inspired
by examples from the Keras library and Scikit-Learn.
'''
import os
import cv2
import numpy as np
...
if missing_images:
    ...
    for img in missing_images[:10]:  # Display up to 10 missing images for reference (in case I am doing it wrong)
        print(img)
