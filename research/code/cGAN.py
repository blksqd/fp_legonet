'''
This is the first attemp to test a conditional GAN, however, 
the architecture contained here proved to be a little too 
basic for the purpose and lacking the necessary baseline of 
training to produce any meaningful results.
The learning has been great thoug and I will continue to 
explore this technique as a viable alternativeto produce 
synthethic data.

Is important to note that much of the extra control steps here 
are for the purpose of learning about the process and to control
where it is. In my machine, I have to be extremely careful with 
the little resources available, as any extra load might throw the 
...
# Start time tracking (verbose purpose only)
